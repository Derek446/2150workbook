...
class ResourceResults extends HTMLElement {
  ...
  _handleResultClick(event) {
    ...
    if (button) {
      ...
      // note that we're finding the data object from the array, not the UI row!
  ...
  disconnectedCallback() {
    // <- when the component is unloaded/removed from the DOM...
  ...
  render() {
    ...
    if (this.#results.length) {
      // resolves true if the results array contains items
